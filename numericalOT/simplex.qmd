...
The Karusk-Kuhn-Tucker optimality conditions write:
\begin{align}
    & A^T \lambda + s = c
    \\
    & Ax = b
...
In other words, if one can find a triplet $(x, \lambda, \mu)$ that satisfies the KKT conditions, then an optimal point $x$.
